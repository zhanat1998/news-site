...
export const CATEGORIES = [
  ...
  },
  {
    ...
    title: 'КЫЛМЫШ-КЫРСЫК',
    slug: 'kylmysh-kyrsyk',
    description: 'Кылмыш жана кырсык жаңылыктары',
    color: '#c62828',
    keywords: ['кылмыш', 'кырсык', 'полиция', 'сот'],
  },
  {
    id: 'science',
    title: 'ИЛИМ-БИЛИМ',
    slug: 'ilim-bilim',
    description: 'Илим жана билим жаңылыктары',
    color: '#0288d1',
    keywords: ['илим', 'билим', 'мектеп', 'университет'],
  },
  {
    id: 'reportage',
    title: 'СОКОЛДУН РЕПОРТАЖДАРЫ',
    slug: 'sokoldun-reportazhdary',
    description: 'Өзгөчө репортаждар',
    color: '#5d4037',
    keywords: ['репортаж', 'журналистика'],
  },
] as const;
