...
export const SearchIcon: FC<SVGProps<SVGSVGElement>> = (props): JSX.Element => (
  <svg aria-label="Издөө" className="x1lliihq x1n2onr6 x5n08af" fill="currentColor" height="24" role="img"
       viewBox="0 0 24 24" width="24"><title>Издөө</title>
